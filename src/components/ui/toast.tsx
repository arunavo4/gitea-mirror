...
export function Toast({ message, type, duration = 3000, onClose }: ToastProps) {
  ...
  return (
    <div
      className={`fixed top-4 right-4 z-50 p-4 rounded-md shadow-md border-l-4 ${bgColor} max-w-md`}
    >
...
export function ToastContainer({ children }: { children: React.ReactNode }) {
  return <div className="fixed top-4 right-4 z-50 space-y-4">{children}</div>;
}
